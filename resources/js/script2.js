...
document.querySelector('.veg-1').addEventListener('click', function () {
    ...
    if (vselect) {
        document.getElementById('veg-name').value = "pitabread";
        price = 60;
        vselected(1);
...
document.querySelector('.veg-2').addEventListener('click', function () {
    if (vselect) {
        document.getElementById('veg-name').value = "fries";
        price = 110;
        vselected(2);
...
document.querySelector('.veg-3').addEventListener('click', function () {
    if (vselect) {
        document.getElementById('veg-name').value = "vegpasta";
        price = 110;
        vselected(3);
...
document.querySelector('.veg-4').addEventListener('click', function () {
    if (vselect) {
        document.getElementById('veg-name').value = "vegpizza";
        price = 110;
        vselected(4);
...
document.querySelector('.veg-5').addEventListener('click', function () {
    if (vselect) {
        document.getElementById('veg-name').value = "vegburger";
        price = 110;
        vselected(5);
...
document.querySelector('.non-veg-1').addEventListener('click', function () {
    ...
    if (nvselect) {
        document.getElementById('nonveg-name').value = "kebab";
        nvorder = 1;
        price = 60;
        nvselected(1);
...
document.querySelector('.non-veg-2').addEventListener('click', function () {
    if (nvselect) {
        document.getElementById('nonveg-name').value = "chickensandwich";
        price = 110;
        nvselected(2);
...
document.querySelector('.non-veg-3').addEventListener('click', function () {
    if (nvselect) {
        document.getElementById('nonveg-name').value = "chickenchilli";
        price = 110;
        nvselected(3);
...
document.querySelector('.non-veg-4').addEventListener('click', function () {
    if (nvselect) {
        document.getElementById('nonveg-name').value = "chickenmanchurian";
        price = 110;
        nvselected(4);
...
function nviconRemove(number) {
    ...
    div.classList.add('overlay');
    uspopup();
    document.getElementById('nonveg-name').value = "";
}
//select an item
...
function init() {
    ...
    document.querySelector('.submit').style.display = 'none';
    document.querySelector('.tq').textContent = '*Total quantiy >= 15';
