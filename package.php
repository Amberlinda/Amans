...
<body>
    ...
    <section class="section-meals clearfix">
        ...
        <div class="form">
            <h1>package menu</h1>
            <form action="packaging.php" method="POST" class="meals-form">
                <div class="form-elements">
                    <input type="text" name="veg_name" id="veg-name" class="pveg-name" disabled>
                    <input type="text" name="nonveg_name" id="nonveg-name" class="pnonveg-name" disabled>
                </div>
                <div class="form-elements">
                    <label>Total(veg)/per plate : Rs.</label>
                    <input type="text" name="veg_total" id="veg-total" placeholder="Total" disabled>
                    
                </div>
                <div class="form-elements"> 
                    <label>Total(non-veg)/per plate : Rs.</label>
                     <input type="text" name="nonveg_total" id="non-veg-total" placeholder="Total" disabled>
                </div>
                <div class="form-elements">
                    <input type="submit" name='action' value="submit" class="submit" style="display: inline-block">
